...
public class EnemyLobo : MonoBehaviour, IDamageable
{
    ...
    void Patrol()
    {
        ...
        firePoint.localPosition = new Vector3(
            movingRight ? Mathf.Abs(firePoint.localPosition.x) : -Mathf.Abs(firePoint.localPosition.x),
    ...
    void Flip()
    {
        ...
        firePoint.localScale = new Vector3(
            -firePoint.localScale.x,
            firePoint.localScale.y,
            firePoint.localScale.z
        );
    }
